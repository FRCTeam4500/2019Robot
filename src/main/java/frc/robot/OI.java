...
public class OI {
    ...
    public OI() {
        if (!driveStick.getName().equals("")) {
			...
			elevatorLow.whenPressed(new Elevator_SetLevel(Robot.elevator,RobotMap.ELEVATOR_LOW));
			elevatorMedium.whenPressed(new Elevator_SetLevel(Robot.elevator,RobotMap.ELEVATOR_MEDIUM));
			elevatorHigh.whenPressed(new Elevator_SetLevel(Robot.elevator,RobotMap.ELEVATOR_HIGH));
        }
    }
