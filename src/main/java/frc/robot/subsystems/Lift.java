...
public class Lift extends Subsystem {
    ...
    public Lift() {
        back = new DoubleSolenoid(0, RobotMap.FRONT_LIFT_SOLENOID_FORWARD_CHANNEL,
                RobotMap.FRONT_LIFT_SOLENOID_REVERSE_CHANNEL);
        front = new DoubleSolenoid(0, RobotMap.BACK_LIFT_SOLENOID_FORWARD_CHANNEL,
                RobotMap.BACK_LIFT_SOLENOID_REVERSE_CHANNEL);
        middle = new DoubleSolenoid(1, RobotMap.MIDDLE_LIFT_SOLENOID_FORWARD_CHANNEL,
