...
public class Autonomous {
    ...
    public void loadTrajectory(File f) {
        ...
        modifier.modify(RobotMap.WHEEL_BASE_WIDTH, RobotMap.WHEEL_BASE_DEPTH, mode);
        ...
        blFollower.configureEncoder(swerve.getBL().getDrivePosition(), RobotMap.TICKS_PER_ROTATION,
                RobotMap.WHEEL_DIAMETER);

        brFollower = new EncoderFollower(modifier.getBackRightTrajectory());
        brFollower.configureEncoder(swerve.getBR().getDrivePosition(), RobotMap.TICKS_PER_ROTATION,
                RobotMap.WHEEL_DIAMETER);
